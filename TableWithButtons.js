...
var TableWithButtons = UnmanagedComponent.extend({
  ...
  update: function() {
    ...
    if(!this.htmlObject) {
      return this.error("TableWithButtons requires an htmlObject");
    }
    try{
      this.block();
      this.setup();
      if(this.chartDefinition.paginateServerside) {
        ...
        var success = _.bind(function(data){
          this.rawData = data;
          this.processTableWithButtonsResponse(data)
        },this);
  ...
  paginatingUpdate: function() {
    ...
    var success = _.bind(function(values) {
      ...
      this.processTableWithButtonsResponse(values);
    },this);
  ...
  processTableWithButtonsResponse : function(json) {
    var myself = this,
        cd = this.chartDefinition,
        extraOptions = {};

    this.ph.trigger('cdfTableWithButtonsProcessResponse');
    ...
    var dtData0 = TableWithButtons.getDataTableOptions(cd);
    ...
    myself.ph.trigger('cdfTableWithButtonsFinishRendering');
  },
